...
reference to an ARRAY of B<Padre::DB::Snippets> objects when called in scalar context.
...
L<Padre::DB::Snippets> object, inserts the appropriate row into the L<snippets>
...
Returns a new L<snippets> object, or throws an exception on error,
