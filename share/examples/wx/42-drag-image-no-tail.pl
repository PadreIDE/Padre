...
#  $this->{_backup}->SelectObject($this->{_bitmap});
  ...
  $this->{_backup}->Blit(0, 0, $this->{_bitmap}->GetWidth, $this->{_bitmap}->GetHeight, $dc, $this->{_bitmap_x}, $this->{_bitmap_y});
...
sub OnMouseMove {
  ...
  $dc->Blit($this->{_bitmap_x}, $this->{_bitmap_y}, $this->{_bitmap}->GetWidth, $this->{_bitmap}->GetHeight, $this->{_backup} ,0,0);
